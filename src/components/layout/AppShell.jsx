import { ArrowRight, BarChart3, BookOpen, Dumbbell, History, Home, User } from 'lucide-react'
...
const titles = {
  '/': 'Your readiness',
  '/practice': 'Practice',
  '/analytics': 'Psychological analytics',
  '/history': 'Practice history',
  '/guide': 'AI evaluation guide',
  '/profile': 'Profile',
}

function Navigation({ mobile = false }) {
  // On mobile bottom bar, display primary 5 items to keep touch targets generous
  const items = mobile
    ? navItems.filter((item) => item.to !== '/guide')
    : navItems
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-card">
          ...
          <p>10 mins today keeps progress moving.</p>
          <NavLink to="/practice/wat">Start quick WAT</NavLink>
        </div>
      </aside>
        ...
        {!isSession && (
          <header className="topbar">
            ...
            <div className="topbar-actions">
              <NavLink to="/guide" className="header-guide-link" title="Evaluation Rubrics & OLQs">
